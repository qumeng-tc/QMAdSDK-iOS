//
//  QMNativeSingleViewController.m
//  QMAdSDK
//
//  Created by xusheng on 2024/11/4.
//

#import "QMNativeSingleViewController.h"
#import <QMAdSDK/QMAdSDK.h>
#import <YYWebImage/UIImageView+YYWebImage.h>
#import <Masonry/Masonry.h>
#import "ViewController.h"

@interface QMNativeSingleViewController () <QMNativeAdDelegate>
...
@implementation QMNativeSingleViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.nativeAd = [[QMNativeAd alloc] initWithSlot:self.slot];
...
- (void)qm_nativeAdLoadSuccess:(QMNativeAd *)nativeAd {
    ...
    QMLog(@"qmTextLogoUrl == %@", nativeAd.meta.qmTextLogoUrl);
    QMLog(@"qmLogoUrl == %@", nativeAd.meta.qmLogoUrl);
