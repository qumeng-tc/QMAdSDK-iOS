#
# Be sure to run `pod lib lint QMAdSDK-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name                  = 'QMAdSDK'
  s.version               = '1.3.7'
  s.summary               = 'QMAdSDK-iOS.'
  s.description           = '趣盟平台'

  s.homepage              = 'https://github.com/qumeng-tc/QMAdSDK-iOS'

  s.license               = { :type => 'MIT', :file => 'LICENSE' }
  s.author                = { 'chenxin02' => 'chenxin02@qutoutiao.net' }
  s.source                = { :git => "https://github.com/qumeng-tc/QMAdSDK-iOS.git" }
...
#  s.resource              = 'QMAdBundle.bundle'
  ...
  s.vendored_frameworks = 'QMAdSDK/QMAdSDK.xcframework'
